/*! react-auth-kit v2.12.5 | Apache-2.0 */
...
/**
     ...
     * limitations under the License.
     */
function(e){return function(t){return i.createElement(s,null,(function(r){if(null===r)throw new p("Auth Provider is missing. Please add the AuthProvider before Router");return r.authState.auth&&T(r.authState)?i.createElement(e,h({},t,{authHeader:"".concat(r.authState.auth.type," ").concat(r.authState.auth.token)})):i.createElement(e,h({},t,{authHeader:""}))}))}}
/**
     * @author Arkadip Bhattacharya <in2arkadipb13@gmail.com>
